// src/features/catalog-command/transactions/components/items/occurrence/semiannual/EditSemiAnnualPage.tsx
...
interface EditSemiAnnualPageProps {
  itemType: number;
}

export default function EditSemiAnnualPage({ itemType }: EditSemiAnnualPageProps) {
    ...
    <div className="p-0 md:p-4 w-full">
      ...
      <Card className="w-full mb-3 px-4 sm:px-6">
        <h2 className="text-lg font-semibold">
          {itemType === 1 ? 'Edit Semi-Annual Credit' : 'Edit Semi-Annual Debit'}
        </h2>
      </Card>
